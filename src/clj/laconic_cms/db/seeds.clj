(ns laconic-cms.db.seeds
  (:require
   [buddy.hashers :as hashers]
   [faker.name :as fname]
   [faker.internet :as finternet]
   [faker.lorem :as florem]
   [laconic-cms.db.core :as db :refer [*db*]]
   [laconic-cms.db.pathom :refer [parser]]
   [laconic-cms.db.sql.common :as common]
   [laconic-cms.db.sql.threaded-comment :as tcomment]
   [laconic-cms.db.sql.user :refer 
    [create-user-with-profile! get-users]] 
   [laconic-cms.db.sql.blog-post :as blog-post :refer [create-post!]]
   [laconic-cms.db.sql.page :refer [create-page!]]
   [user :refer [reset-db]]))
